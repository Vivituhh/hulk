...
impl Widget for &mut RemotePanel {
    fn ui(self, ui: &mut eframe::egui::Ui) -> eframe::egui::Response {
        ...
        if let Some(gamepad) = self.active_gamepad.map(|id| self.gilrs.gamepad(id)) {
            ...
            let should_kick = get_axis_value(gamepad, Axis::DPadX).unwrap_or(1.0) != 0.0;
            ...
            ui.vertical(|ui| {
                ...
                let label_3 = ui.label(&format!("Kick: {} {} ", should_kick, in_walk_kick));
